# Top Down Clustering
# refine_criterion uses sgn, not qvec
# ties in clustering are broken randomly

# THIS IS A CLONE OF method2.py with a single change: the bug present in method1.py is reintroduced.
# Record is now 3. Kill me. Why does this bug outperform the normal algorithm.
...
def example():
    ...
    N = 100
    for i in range(N):
        current_model = TopDownSgnFarthestPair(circuit=circuit)
        current_model.model()
