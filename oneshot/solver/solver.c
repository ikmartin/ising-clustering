...
double *RHS; // RHS for linear problem (by default, all equal to 1)
...
double *sparse_interface(int num_rows, int num_cols, int8_t *values, int *row_index, int *col_ptr, int num_workers, double tolerance, int max_iter, double init_eta, double eta_decay, int keep_init, double *RHS_set)
{
	m = num_rows;
	n = num_cols;
